...
# Please instead update this file by running `bin/tapioca dsl LineItem`.
...
class LineItem
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::LineItem).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(Numeric) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::LineItem).void)).returns(::LineItem) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::LineItem])
    end
    def find(args); end

    sig { params(args: T.untyped).returns(T.nilable(::LineItem)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::LineItem) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.proc.params(object: ::LineItem).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::LineItem]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::LineItem]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::LineItem)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::LineItem) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::LineItem) }
    def find_sole_by(arg, *args); end

    sig { params(limit: NilClass).returns(T.nilable(::LineItem)) }
    sig { params(limit: Integer).returns(T::Array[::LineItem]) }
  ...
  module GeneratedAssociationMethods
    ...
    sig { params(args: T.untyped, blk: T.untyped).returns(::ShoppingCart) }
    def build_shopping_cart(*args, &blk); end
    ...
    sig { params(args: T.untyped, blk: T.untyped).returns(::ShoppingCart) }
    def create_shopping_cart(*args, &blk); end
    ...
    def reload_shopping_cart; end

    sig { returns(T.nilable(::ShoppingCart)) }
    def shopping_cart; end

    sig { params(value: T.nilable(::ShoppingCart)).void }
    def shopping_cart=(value); end
  end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::LineItem, T::Enumerable[T.any(::LineItem, T::Enumerable[::LineItem])])
    ...
    sig do
      params(
        records: T.any(::LineItem, Integer, String, T::Enumerable[T.any(::LineItem, Integer, String, T::Enumerable[::LineItem])])
      ).returns(T::Array[::LineItem])
    end
    ...
    sig do
      params(
        other_array: T.any(::LineItem, T::Enumerable[T.any(::LineItem, T::Enumerable[::LineItem])])
      ).returns(T::Array[::LineItem])
    end
