...
class Category
  ...
  module GeneratedAssociationMethods
    sig { params(args: T.untyped, blk: T.untyped).returns(::CachedImage) }
    def build_cached_image(*args, &blk); end
    ...
    def cached_image; end

    sig { params(value: T.nilable(::CachedImage)).void }
    def cached_image=(value); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::CachedImage) }
    def create_cached_image(*args, &blk); end
